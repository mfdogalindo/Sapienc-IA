  ...
  useEffect(() => {
    if (fetcher.state === 'idle' && fetcher.data) {
      ...
      if (fetcher.data.file) {
        setFiles(prevFiles => [...prevFiles, fetcher.data.file]);
        setUploadError(null);
      }
      // Handle file list update
      else if (fetcher.data.files) {
    ...
    <div className="h-full">
      <div className="mb-6">
        ...
        <p className="text-gray-400">
          Upload and manage files for project: {selectedProject.name}
        </p>
      </div>
      ...
      >
        <div className="flex flex-col items-center">
          ...
          <p className="text-sm text-gray-500 mb-4">
            Supported formats: TXT, CSV, JSON, JS, TS, JSX, TSX, MD, PY, YML, YAML (Max 5MB)
          </p>
      ...
      {uploadError && (
        <div className="bg-red-500 bg-opacity-20 text-red-300 p-4 rounded-md mb-6">
          {uploadError}
        </div>
      )}
